    ...
    <div className="shadow-xs py-6 lg:py-10 z-50 relative">
        ...
        <div className="justify-center lg:pt-8 hidden lg:flex">
            <ul className="list-reset flex items-center">
                ...
                <li className="mr-10">
                    <Link  href="/about">
                    <a className="block text-lg font-hk hover:font-bold transition-all text-secondary hover:text-primary border-b-2 border-white hover:border-primary px-2">About</a>
                    </Link>
</li>
